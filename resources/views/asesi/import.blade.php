...
@section('title', 'Import Data Asesi')

@section('content')
<div class="card">
    <div class="card-header">
        <h5 class="mb-0">Import Data Asesi</h5>
    ...
    <div class="card-body">
        <nav aria-label="breadcrumb">
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item"><a href="{{ route('asesi.index') }}">Referensi</a></li>
                <li class="breadcrumb-item active">Asesi</li>
            </ol>
        </nav>
        ...
        <div class="row">
            <div class="col-md-8">
                <div class="card bg-light">
                    <div class="card-header">
                        <h6 class="mb-0">Data Asesi</h6>
                    </div>
                    <div class="card-body">
                        <a href="{{ route('asesi.download-template') }}" class="btn btn-success btn-lg mb-4">
                            <i class="bi bi-download"></i> Unduh Template Excel
                        </a>

                        <h6 class="mt-4 mb-3">Unggah Data Asesi</h6>
                        <form action="{{ route('asesi.import-data') }}" method="POST" enctype="multipart/form-data">
                            @csrf
                            <div class="mb-3">
                            ...
                            <div class="d-grid gap-2 d-sm-flex">
                                ...
                                <a href="{{ route('asesi.index') }}" class="btn btn-secondary">
